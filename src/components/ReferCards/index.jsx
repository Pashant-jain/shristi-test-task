        ...
        <div className={style.ReferCards_inner}>
          ...
          <div className={`${style.ReferCard} ${style.ReferCard2}`}>
            <div className={style.cardContent}>
              ...
              <p>
                Experience unparalleled joy with our exclusive perks, from high-stakes adventures to unforgettable
                triumphs!
              </p>
              <MainButton size='small' variant='primary' className={style.womenBtn}>
                Play Now
              </MainButton>
            </div>
          </div>
